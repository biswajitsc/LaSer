...
\section{Outline of workflow}
	...
	The Backend is running on a python server and html and php are used as the frontend
...
\begin{itemize}
	...
	\item Currently, n-gram features are supported where n <= 3, we will also support normalization and structural features in future.
